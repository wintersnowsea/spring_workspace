...
<%@page import="com.edu.springshop.admin.domain.Pimg"%>
...
<body>
                    ...
                    <div class="product__details__pic">
                        ...
                        <div class="product__details__slider__content">
                            ...
                            <div class="product__details__pic__slider owl-carousel">
                                <img data-hash="product-1" class="product__big__img" src="/resources/data/<%= pimg.getFilename()%>" alt="">
                            </div>
                            <%} %>
                        </div>
                    </div>
	...
	app1=new Vue({
		el:"#app1",
		data:{
			//디자인 영역에 v-model로 선언된 컴포넌트와 이 변수는 서로 동기화되어 있음 (binding)
			//어느 한쪽이 바뀌어도 둘 다 동일한 효과를 냄
			ea:3  
		},
		methods:{
			getSum(){
				//alert();
				//console.log("입력값은 "+app1.ea);
				$("#total").html(app1.ea);
			}
		}
	});
	...
	function addCart(){
		...
		$.ajax({
			url:"/rest/shop/cart",
			type:"post",
			data:JSON.stringify(param),  //서버에 json 전송  //객체 자체를 전송할 수 없기에 문자열로 변환하여 전송
			contentType:"application/json",  //header에 데이터 종류 명시
