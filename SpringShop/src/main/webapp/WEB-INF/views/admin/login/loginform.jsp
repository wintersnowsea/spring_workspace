...
<body class="hold-transition">
		...
		<div class="card card-info">
		    ...
		    <form class="form-horizontal" id="form1">
		        ...
		        <div class="card-footer">
		            <button type="button" class="btn btn-info" id="bt_loginasync">비동기Login</button>
		            <button type="button" class="btn btn-info" id="bt_login">동기Login</button>
	...
	<script type="text/javascript">
		...
		$(function() {
			$("#bt_loginasync").click(function() { //비동기로그인 요청
				loginAsync();
			});
			$("#bt_login").click(function() { //동기로그인 요청
				login();
			});
		});
